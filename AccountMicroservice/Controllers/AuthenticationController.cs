...
namespace AccountMicroservice.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        [HttpGet("GetAllUser_Roles")]
        public async Task<List<User_Role>> GetUserRoleDrop()
        {
            var User_Role = await _dbcontext.User_Roles.ToListAsync();
        ...
        public async Task<IActionResult> EditUser([FromBody] EditUser userToUpdate)
        {
            ...
            var userrole = await _dbcontext.User_Roles.FirstOrDefaultAsync(y => y.UserId.Equals(userToUpdate.UserId));
